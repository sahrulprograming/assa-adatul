			...
			<ul>
				<li>
					...
					<ul>
						<li> <a href="<?= base_url(
                            'admin/siswa'
                        ) ?>"><i class="bx bx-right-arrow-alt"></i>Semua Siswa</a>
						</li>
						<?php foreach ($kelas as $k): ?>
						<li>
							<a href="<?= base_url(
                                    'admin/siswa/data_siswa/' . $k['id_kelas']
                                ) ?>"><i class="bx bx-right-arrow-alt"></i>Kelas <?= $k[
    'nama_kelas'
] ?></a>
						</li>
						<?php endforeach; ?>
						<li> <a href="<?= base_url(
                            'admin/siswa/siswa_non_active'
                        ) ?>"><i class="bx bx-right-arrow-alt"></i>Siswa Non Active</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						...
						<li>
							...
							<ul>
								<li>
									<a href="<?= base_url(
                                    'admin/penilaian/index/' . $k['id_kelas'] . "/1"
                                ) ?>"><i class="bx bx-right-arrow-alt"></i>Semester 1</a>
								</li>
								<li>
									<a href="<?= base_url(
                                    'admin/penilaian/index/' . $k['id_kelas'] . "/2"
                                ) ?>"><i class="bx bx-right-arrow-alt"></i>Semester 2</a>
								</li>
							</ul>
						</li>
						<?php endforeach; ?>
