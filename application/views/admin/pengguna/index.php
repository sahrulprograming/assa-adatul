    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?= base_url('admin/pengguna/tambah_pengguna'); ?>" class="btn btn-success mb-3">Tambah Pengguna</a>
                    ...
                    <table id="table2" class="table table-striped table-bordered">
                        <thead class="table-secondary text-center">
                            <tr>
                                ...
                                $keys = $th;
                                foreach (array_slice($th, 1, 5) as $th) :
                                ?>
                                    ...
                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                        <div class="modal-content bg-danger">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-white">Hapus pengguna</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <div class="text-white">
                                                    <h5 class="text-white">Yakin ingin menghapus pengguna?</h5>
                                                    <div class="row mb-3">
                                                        <label for="id_admin" class="col-sm-3 col-form-label">id pengguna</label>
                                                        <div class="col-sm-9">
                                            ...
                                            <div class="modal-footer">
                                                <?= form_open('admin/pengguna/hapus_pengguna'); ?>
                                                <input type="hidden" value="<?= $admin[$keys[0]]; ?>" name="id_admin">
                                                <input type="hidden" value="<?= $admin[$keys[6]]; ?>" name="foto">
