        ...
        <div class="card border-top border-0 border-4 border-info">
            <div class="card-body">
                ...
                <div class="border p-4 rounded">
                    ...
                    <hr />
                    <?= form_open_multipart("admin/kriteria/tambah_kriteria/"); ?>
                    <div class="row mb-3">
                        <label for="kriteria" class="col-sm-3 col-form-label">Kriteria</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="kriteria" name="kriteria" value="<?= set_value('kriteria'); ?>" placeholder="Masukan nama kriteria">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="bobot" name="bobot" value="<?= set_value('bobot'); ?>" placeholder="Masukan jumlah bobot">
